...
<template>
  ...
  <section class="rounded-2xl bg-surface border border-border p-5">
    ...
    <div v-if="!hayDatos" class="text-center">
      <p class="font-display font-bold text-ink">Resumen anual</p>
      <p class="mt-1 text-sm text-muted">
        Cuando cierres tu primer mes, aquí verás el resumen del año.
      </p>
    </div>
    ...
    <div v-else>
      ...
      <h2 class="font-display font-bold text-lg text-ink">Resumen {{ año }}</h2>
      ...
      <div class="mt-4 grid grid-cols-2 gap-4 sm:grid-cols-3">
        ...
        <div>
          <p class="text-xs text-muted">Ahorro</p>
          <p
        ...
        <div>
          <p class="text-xs text-muted">Media gastos/mes</p>
          <p class="font-display font-bold text-ink">{{ euro(mediaGastos) }}</p>
        </div>
        <!-- Mejor mes por disponible -->
        <div>
          <p class="text-xs text-muted">Mejor mes</p>
        ...
        <div>
          <p class="text-xs text-muted">Peor mes</p>
          <p class="font-display font-bold text-brand">

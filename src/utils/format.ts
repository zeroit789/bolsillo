/* =============================================================================
 * format.ts — Formato de moneda y fechas / Currency & date formatting
 * -----------------------------------------------------------------------------
 ...
 * -----------------------------------------------------------------------------
 * ÍNDICE / INDEX:
 *   1. Moneda y locale reactivos / Reactive currency & locale
 *   2. Formateador de moneda / Currency formatter
 *   3. Formateadores de fecha / Date formatters
 *   4. Aritmética de meses (YYYY-MM) / Month arithmetic (YYYY-MM)
 * ===========================================================================*/
import { ref } from "vue";
...
// ES: Cambia el locale de fecha activo. / EN: Changes the active date locale.
...
export function mesLegible(mes: string): string {
  ...
  // ES: capitaliza el mes. / EN: Capitalize the first letter of the month.
  return texto.charAt(0).toUpperCase() + texto.slice(1);
}

// ── 4. Aritmética de meses (YYYY-MM) / Month arithmetic (YYYY-MM) ─────────────
// ES: Mes actual en formato "YYYY-MM". / EN: Current month in "YYYY-MM" format.

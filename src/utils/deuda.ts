/* =============================================================================
 * deuda.ts — Lógica de amortización de deudas / Debt amortization logic
 * -----------------------------------------------------------------------------
 ...
 * -----------------------------------------------------------------------------
 * ÍNDICE / INDEX:
 *   1. Estado de la deuda en un mes / Debt state for a month
 *   2. Comprobar si se salda este mes / Settled-this-month check
 * ===========================================================================*/

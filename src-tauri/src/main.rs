// =============================================================================
// main.rs — Punto de entrada del binario de escritorio / Desktop binary entry point
// -----------------------------------------------------------------------------
...
// -----------------------------------------------------------------------------
// ÍNDICE / INDEX:
//   1. atributo del subsistema de Windows / Windows subsystem attribute
//   2. main() — delega en bolsillo_lib::run / delegates to bolsillo_lib::run
// =============================================================================
